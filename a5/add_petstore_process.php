<?php
// show errors while you’re testing
...
// If something is missing, show the normal page layout
// and then print the error message at the bottom
// If something is missing, show the normal page layout
// and then print the error message at the bottom
//see: http://www.qcitr.com/demos/isset_vs_empty.php
// empty() function: returns true for the following values: empty string (""), 0, "0", NULL, or FALSE
...
// isset() function: checks whether variable is set--that is, it must be declared and is not NULL
