		...
		<div class="starter-template">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="30"
                                name="name" placeholder="(max 30 characters)" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" maxlength="30"
                                name="street" placeholder="(max 30 characters)" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" maxlength="30"
                                name="city" placeholder="(max 30 characters)" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="2"
                                name="state" placeholder="Example: FL" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="9"
                                name="zip" placeholder="(5 or 9 digits no dashes)" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="10"
                                name="phone" placeholder="(10 digits no other characters)" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" maxlength="100"
                                name="email" placeholder="Example: jdoe@aol.com" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" maxlength="100"
                                name="url" placeholder="Example: www.jdoe.com" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" maxlength="11" name="ytd_sales" placeholder="Example: 100.00 (no other characters)" />
                        </div>
                    </div>
